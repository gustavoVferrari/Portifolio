...
#     # outlier treatment
#     outlier = Winsorizer(variables=num_var_2, capping_method='gaussian', tail='both', fold=4.0)
...
def feat_eng_pipeline(
    ...
    # outlier treatment
    outlier = Winsorizer(variables=num_var_2, capping_method='gaussian', fold=4)
