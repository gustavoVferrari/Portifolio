...
def train_model(**params):
    ...
    voting = VotingClassifier(
        estimators=[
            ('rf', models['rf'].set_params(**best_model_params['rf'], random_state=seed_)),
            ('ab', models['ab'].set_params(**best_model_params['ab'], random_state=seed_)),
            ('gb', models['gb'].set_params(**best_model_params['gb'], random_state=seed_)),
            ('lr', models['lr'].set_params(**best_model_params['lr'], random_state=seed_)),
            ('svc', models['sv'].set_params(**best_model_params['sv'], random_state=seed_)),
            ('mlc', models['ml'].set_params(**best_model_params['ml'], random_state=seed_)),
            ('hgc', models['hg'].set_params(**best_model_params['hg'], random_state=seed_)),
     ],
    voting='soft',
